...
# Default Covenant University credentials - Updated with hall_officer
DEFAULT_CREDENTIALS = {
    "student": {
    ...
    "hall_officer": {  # Fixed: changed from "manager" to "hall_officer"
        "email": "hall.officer@cu.edu.ng",
        "password": "officer123",  # Fixed: changed from "manager123"
        "name": "Hall Officer",
        "role": "hall_officer"  # Fixed: changed from "manager"
    },
    "officer": {
...
async def login(credentials: LoginCredentials, db: Session = Depends(get_db)):
    ...
    - Hall Officer: hall.officer@cu.edu.ng / officer123  # Fixed
