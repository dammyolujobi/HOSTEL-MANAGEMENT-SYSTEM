...
export default function NewMaintenanceRequestPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const requestData = {
        student_ID: currentUser.student_ID || currentUser.id, // Use the actual student_ID from login
        room_ID: currentUser.room_ID || 1, // Use the actual room_ID from login
        category_ID: Number.parseInt(formData.category_ID),
        description: formData.description,
        availability: formData.availability || undefined, // Changed from null to undefined
